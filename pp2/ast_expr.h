...
class IncrementalExpr : public CompoundExpr 
{
  public:
    IncrementalExpr(Operator *op, Expr *rhs) : CompoundExpr(op,rhs) {}
    //IncrementalExpr(Operator *op, Expr *rhs) : CompoundExpr(op,rhs) {}
    const char *GetPrintNameForNode() { return "IncrementalExpr"; }
};

class DecrementalExpr : public CompoundExpr 
{
  public:
    DecrementalExpr(Operator *op, Expr *rhs) : CompoundExpr(op,rhs) {}
    //IncrementalExpr(Operator *op, Expr *rhs) : CompoundExpr(op,rhs) {}
    const char *GetPrintNameForNode() { return "DecrementalExpr"; }
};
